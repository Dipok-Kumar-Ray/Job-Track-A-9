...
const CareerTipsSection = () => {
    ...
    <div>
      ...
      <section className="py-12  w-11/12 mx-auto rounded-2xl">
        <h2 className="text-3xl font-bold text-center mb-8"> Career Tips</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto px-4">
          {tips.map(tip => (
            <div key={tip.id} className="p-6 bg-amber-50 rounded-lg shadow hover:shadow-md transition">
              <h3 className="text-blue-300 text-lg font-semibold mb-2">{tip.title}</h3>
